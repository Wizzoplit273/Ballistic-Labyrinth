...
func _process(_delta: float) -> void:
	...
	if Input.is_action_just_pressed("DEBUG_Toggle_Maze_Generation"):
	...
	if Input.is_action_just_pressed("DEBUG_Show_Dodging"):
...
#func update_player_information(player_register: PlayerRegister, players_count: int) -> void:
	...
	### modulation will not send update if it's equal to Color.TRANSPARENT (i.e. Color(1.0, 1.0, 1.0, 0.0))
